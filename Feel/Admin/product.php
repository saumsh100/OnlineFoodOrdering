...
<div class="container">
<h1 class="text-center" style="color:red">PRODUCTS CRUD</h1>
	<div class="row">
		<div class="col-md-12">
			...
			<tbody>
				<?php
					...
					while($row=$query->fetch_array()){
						?>
						<tr>
							<td><a href="<?php if(empty($row['photo'])){echo "../user/img/";} else{echo $row['photo'];} ?>"><img src="<?php if(empty($row['photo'])){echo "../user/img/";} else{echo $row['photo'];} ?>" height="30px" width="40px"></a></td>
